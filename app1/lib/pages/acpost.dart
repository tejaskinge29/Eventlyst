...
class acpost extends StatefulWidget {
  @override
  _acpostState createState() => _acpostState();
}

class _acpostState extends State<acpost> {
  ...
  Future<List<Map<String, dynamic>>> fetchPosts() async {
    try {
      ...
      if (userId != null) {
        ...
        // Fetch documents from the collection where user_id is equal to the current user's ID
        QuerySnapshot<Map<String, dynamic>> postsQuery =
            await postsCollection.where('user_id', isEqualTo: userId).get();
